 ...
 const notes = [
     ...
     "Another year older, another year of making memories. Happy Birthday to the one I adore! 🎈❤️",
 ...
 const videos = [
     "img/document.mp4" // Replace with actual video URLs or paths
 ];
 ...
 function displayNoteAndTime(index) {
     ...
     const videoElement = document.getElementById("note-video");
     videoElement.src = videoSrc;
     videoElement.load();

     // Add event listener to detect video loading failure
